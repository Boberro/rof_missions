...
class car : baseMan
{
    ...
    headgear[] = {"usm_helmet_pasgt_ce_dcu", "usm_helmet_pasgt_ceswd_dcu"};
    vest[] = {"usm_vest_pasgtdcu_lbv_rm_m"};
    backpack[] = {};
    primaryWeapon[] = 
    {
        "mbg_m16a2"
...
class g : car
{
    ...
    vest[] = {"usm_vest_pasgtdcu_lbv_gr_m"};
...
class sl : car
{
    ...
    vest[] = {"usm_vest_pasgtdcu_lbv_rmp_m"};
...
class ar : car
{
    ...
    vest[] = {"usm_vest_pasgtdcu_lbv_mg_m"};
